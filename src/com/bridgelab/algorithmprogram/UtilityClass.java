...
public class UtilityClass {
	...
	public static void main(String[] args) {
        ...
        System.out.println("start time is "+(k));
		System.out.println("enter the array elements");
		for(int i=0;i<n4;i++) 
		{
        ...
        System.out.println("end time is "+(l));
        ...
        System.out.println("elapsed time is "+(m));
       break;
        ...
        System.out.println("start time is "+(q));
		System.out.println("enter the array elements");
		for(int i=0;i<n6;i++) 
		{
        ...
        System.out.println("end time is "+(r));
		AlgorithmUtility.bubble_Sort_String(array6);
		long s=FunctionalUtility.elapse();
        System.out.println("elapsed time in milisecond "+(s));
		}
